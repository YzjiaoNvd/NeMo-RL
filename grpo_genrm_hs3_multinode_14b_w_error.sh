...
NAME="grpo_hs3_16K_step240_clip_max_0.28_${MODEL_NAME}_lr_${lr}_temp_${temp}_kl_${kl}_grpo_bs_${grpo_bs}_rollout_${rollouts_per_prompt}_num_prompts_${prompts_per_step}_${reward}_error"
...
sbatch \
    ...
    --job-name=grpo_genrm_hs3_${MODEL_NAME}_${lr}_${rollouts_per_prompt}_${reward}${data_version}_w_error \
